...
pub trait UserRepository: Send + Sync {
    async fn find_by_uuid(&self, uuid: Uuid) -> RepositoryResult<User>;
    async fn find_by_name(&self, name: &str) -> RepositoryResult<User>;
    async fn create(&self, user: User) -> RepositoryResult<()>;
    async fn delete(&self, uuid: Uuid) -> RepositoryResult<()>;
    async fn update_password_hash(&self, uuid: Uuid, password_hash: String)
    -> RepositoryResult<()>;
}
...
impl UserRepository for PostgresUserRepository {
    ...
    async fn create(&self, item: User) -> RepositoryResult<()> {
